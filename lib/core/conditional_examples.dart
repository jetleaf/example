...
@ConditionalOnMissingClass([ClassType<DataSource>(), ClassType.named('dataSource', "test")])
...
@ConditionalOnPod([ClassType<DataSource>(), ClassType<CacheManager>()])
...
@ConditionalOnClass([ClassType<MessageBroker>()])
