...
class ApplicationLifecycle {
  ...
  void onContextLoaded(ConfigurableApplicationContext context) {
    logger.log("📦 Context loaded with ${context.getDefinitionNames()} aware pods");
  }

  /// Context prepared → last chance to tweak pods
  @OnContextPrepared()
...
class EventConsumers {
  ...
  @EventListener(EventType<ContextSetupEvent>('core'))
